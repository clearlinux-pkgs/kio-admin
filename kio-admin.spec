...
Version  : 24.05.0
Release  : 12
URL      : https://download.kde.org/stable/release-service/24.05.0/src/kio-admin-24.05.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/kio-admin-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/kio-admin-24.05.0.tar.xz.sig
...
%setup -q -n kio-admin-24.05.0
cd %{_builddir}/kio-admin-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716576378
mkdir -p clr-build
pushd clr-build
